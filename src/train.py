...
df = pd.read_csv('C:/Users/Lohith/Desktop/Project/Classification/input/data.csv')
...
plt.ylabel('Accuracy')
plt.legend()
plt.savefig('C:/Users/Lohith/Desktop/Project/Classification/outputs/accuracy.png')
plt.show()
# loss plots
plt.figure(figsize=(10, 7))
...
plt.ylabel('Loss')
plt.legend()
plt.savefig('C:/Users/Lohith/Desktop/Project/Classification/outputs/loss.png')
plt.show()
